...
// Pointeur de la structure map en global pour l'utilisé de toutes les fonctions qui se trouve dans ce .C
// Global
Map map;
...
* SORTIE : /
* 
* DESCRIPTION : Sert à charger une image pour initialisé la SDL
***********************************************************************/
void initMaps(void)
{
...
Elle sera pratique pour pouvoir récupérer cette variable depuis un autre fichier
*
************************************************************************************/
...
* SORTIE : /
* 
* DESCRIPTION : fait le ménage à la fin du programme en supprimant de la mémoire notre fichier map.background
****************************************************************************************************************/
void cleanMaps(void)
{
	...
	{
		// Détruit la texture si elle est chargé
	...
	if (map.tileSet != NULL)
	{
		// Détruit les tileset si elle est chargé
...
* SORTIE : /
* 
* DESCRIPTION : Cette fonction va chargé et lire la map venant d'un fichier externe.
* Une fois les tileset lu on les copie dans les tableaux afin de les dessineées
****************************************************************************************/
void loadMap(char* name)
{
	int x, y;
	FILE* fp; // Interpréteur de fichier
